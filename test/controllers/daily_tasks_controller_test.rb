...
class DailyTasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create daily_task" do
    assert_difference('DailyTask.count') do
      post daily_tasks_url, params: { daily_task: { is_completed: @daily_task.is_completed, line_user_id: @daily_task.line_user_id, task_id: @daily_task.task_id } }
    end
  ...
  test "should update daily_task" do
    patch daily_task_url(@daily_task), params: { daily_task: { is_completed: @daily_task.is_completed, line_user_id: @daily_task.line_user_id, task_id: @daily_task.task_id } }
